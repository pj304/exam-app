...
export default function ExamPage() {
    ...
    // Get question number offset based on section
                ...
                <main className="max-w-5xl mx-auto px-4 py-8">
                    ...
                    <div className="flex gap-2 md:gap-4 mb-8 justify-center flex-wrap">
                        <button
                            ...
                            className={`px-4 md:px-6 py-3 rounded-lg font-medium transition-all flex items-center gap-2 ${currentSection === 'multiple_choice'
                        ...
                        <button
                            ...
                            className={`px-4 md:px-6 py-3 rounded-lg font-medium transition-all flex items-center gap-2 ${currentSection === 'identification'
                        ...
                        <button
                            ...
                            className={`px-4 md:px-6 py-3 rounded-lg font-medium transition-all flex items-center gap-2 ${currentSection === 'code_analysis'
                    ...
                    <div className="glass-card p-4 mb-6 text-center">
                        {currentSection === 'multiple_choice' && (
                            <p className="text-sm text-exam-muted">
                                <span className="text-blue-400 font-medium">Part I: Multiple Choice</span> —
                                Select the best answer for each question. (20 items × 2 points = 40 points)
                            </p>
                        )}
                        {currentSection === 'identification' && (
                            <p className="text-sm text-exam-muted">
                                <span className="text-purple-400 font-medium">Part II: Identification</span> —
                                Write the correct answer. (10 items × 3 points = 30 points)
                            </p>
                        )}
                        {currentSection === 'code_analysis' && (
                            <p className="text-sm text-exam-muted">
                                <span className="text-green-400 font-medium">Part III: Code Analysis</span> —
                                Analyze the C program and write the exact output. (5 items × 6 points = 30 points)
                            </p>
                        )}
                    </div>
